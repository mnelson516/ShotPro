package com.nelson.shotlogger.presentation.addexercise
...
import com.nelson.shotlogger.presentation.util.InputValidator
...
fun AddExerciseScreenContent(
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            label = {
                Text("Exercise Name (e.g 'Catch and Shoot')")
            },
